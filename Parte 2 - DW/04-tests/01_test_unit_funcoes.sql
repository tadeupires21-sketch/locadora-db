...
BEGIN
    ...
    PERFORM pg_temp.assert_eq('status_cobranca inválido -> desconhecido',
        stg.fn_normaliza_status_cobranca('estornado'), 'desconhecido');
    PERFORM pg_temp.assert_eq('status_cobranca nulo -> desconhecido',
        stg.fn_normaliza_status_cobranca(NULL), 'desconhecido');
